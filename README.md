...
> * поддержка перелистывания слайдов смахиванием (touch swipe) для устройств с сенсорным экраном и перетаскиванием мышью (при изменении в файле task4.js стр.56 конфигурации слайдера swipe с false на true) – разрешает листать слайды свайпом и перемещением курсора мыши при зажатой левой кнопки мыши;
